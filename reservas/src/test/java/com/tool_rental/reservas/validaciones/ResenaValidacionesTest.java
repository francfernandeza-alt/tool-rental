...
public class ResenaValidacionesTest {
    ...
    void setUp() {
        ReflectionTestUtils.setField(
                resenaValidaciones,
                "herramientasUrl",
                "http://herramientas/api/v1/herramientas"
        );
    ...
    void validarHerramientaExistenteNoDebeLanzarErrorSiServicioResponde() {
        ...
        when(requestHeadersUriSpec.uri("http://herramientas/api/v1/herramientas/1")).thenReturn(requestHeadersSpec);
        ...
        verify(requestHeadersUriSpec).uri("http://herramientas/api/v1/herramientas/1");
